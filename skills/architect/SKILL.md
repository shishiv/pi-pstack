...
Use the exploration, implementation, review, and judgment roles from the shared delegation contract. Pass an explicit model only when the host reports it as available and a cross-provider comparison is intentional.
