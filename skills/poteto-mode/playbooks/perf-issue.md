...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to the configured `worker`; review the diff. Capture a post-fix trace.
