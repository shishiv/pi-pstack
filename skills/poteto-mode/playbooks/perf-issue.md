...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate with the implementation role; review the diff. Capture a post-fix trace.
