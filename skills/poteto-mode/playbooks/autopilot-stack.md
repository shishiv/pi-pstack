...
autonomy, then hand the operator one linear reviewed stack.** The selected
delivery adapter is optional and must pass capability preflight. For "autopilot-stack", "stack
