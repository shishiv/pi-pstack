...
State your read of scope and constraints in one paragraph. Use `ask` only for genuinely ambiguous intent (the **never-block-on-the-human** principle skill); give concrete options with each open question.
