...
- Confidence: candidate
- Skip when: Bugbot flags an export, component, helper, or file as unused, and the selected stack adapter's view, upper-stack diffs, or PR context proves a later PR uses it.
