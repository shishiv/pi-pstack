...
- Existing-skill-first: propose `new skill via playbooks/authoring-a-skill.md:` only when no existing skill is a real home, the pattern recurs, and the topic deserves its own skill.
...
| <new pattern, no existing skill is a real home> | <draft a new skill via playbooks/authoring-a-skill.md> | <new skill via playbooks/authoring-a-skill.md: <kebab-name>> |
