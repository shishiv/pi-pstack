...
Copy this file outside `.pi/pstack/benny/`, for example to `.pi/benny/routing.md`, and replace every placeholder. Point `routing.map_path` at the copy. Pack refreshes must not overwrite it.
