...
Copy this file outside `.pi/pstack/benny/`, for example to `.pi/pstack/benny-config/routing.md`, and replace every placeholder. Point `routing.mapPath` at the copy. Pack refreshes must not overwrite it.
