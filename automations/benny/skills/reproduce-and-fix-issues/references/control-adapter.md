...
Set the completed user-facing feature map path in `control.featureMapPath`. Copy and fill [`feature-map.example.md`](./feature-map.example.md) outside `.pi/pstack/benny/` instead of editing the copied example.
